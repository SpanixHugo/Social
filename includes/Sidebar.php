...
<div class="iq-sidebar">
  <div id="sidebar-scrollbar" data-scrollbar="true" tabindex="-1" style="overflow: hidden; outline: none;">
        ...
        <ul id="iq-sidebar-toggle" class="iq-menu">
          ...
          <li>
            ...
            <ul id="mailbox" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
              <li><a href="app/./newsfeed"><i class="ri-inbox-line"></i>Inbox</a></li>
    ...
    <div class="scrollbar-track scrollbar-track-y" style="display: block;">
      <div class="scrollbar-thumb scrollbar-thumb-y" style="height: 39.624px; transform: translate3d(0px, 0px, 0px);"></div>
    </div>
  </div>
</div>